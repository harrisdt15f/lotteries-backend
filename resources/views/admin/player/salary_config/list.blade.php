                    ...
                    @if (count($data['data']) > 0)
                        @foreach($data['data'] as $item)
                            <tr role="row" class="odd">
                                ...
                                <td>
                                    <a href="{{route("userSalaryConfigAdd",  [$item->id])}}">编辑</a>
                                    <a class="status-btn" href="javascript:void(0)" ref="{{route("userSalaryConfigStatus", [$item->id])}}">
                                        @if($item->status == 1)
                                            禁用
                                        @else
                                            启用
                                    ...
                                    <a href="{{route("userSalaryConfigDel",  [$item->id])}}">删除</a>
                                </td>
                            </tr>
                        @endforeach
                    @else
