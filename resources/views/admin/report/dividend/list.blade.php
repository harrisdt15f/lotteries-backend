                ...
                <form id="searchForm" action="{{ $currentUrl }}">
                    ...
                    <div class="dt-toolbar col-md-12">
                        <div class="form-group  col-md-3">
                            <label class="col-md-5 control-label">{{__("dividend.search.username")}}:</label>
                            <div class="col-md-2">
                                <input name="username" id="username" class="form-control" value="{{isset($c['username']) ? $c['username'] : ""}}">
                            </div>
                        </div>
                        <div class="form-group  col-md-3">
                            <label class="col-md-5 control-label">{{__("dividend.search.start_day")}}:</label>
                            <div class="col-md-2">
                                <input name="start_day" id="start_day" class="form-control" value="{{isset($c['start_day']) ? $c['start_day'] : ""}}">
                            </div>
                        </div>
                        <div class="form-group  col-lg-3">
                            <label class="col-md-6 control-label">{{__("dividend.search.end_day")}}:</label>
                            <div class="col-md-4">
