        ...
        <fieldset>
            ...
            @if ($configParent)
                <div class="form-group">
                    <label class="col-md-2 control-label">{{__("field.configure.parent_sign")}}</label>
                    <div class="col-md-6">
            ...
            <div class="form-group">
                <label class="col-md-2 control-label">{{__("field.configure.name")}}</label>
                <div class="col-md-6">
            ...
            <div class="form-group">
                <label class="col-md-2 control-label">{{__("field.configure.sign")}}</label>
                <div class="col-md-6">
            ...
            <div class="form-group">
                <label class="col-md-2 control-label">{{__("field.configure.value")}}</label>
                <div class="col-md-6">
