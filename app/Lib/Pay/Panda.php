...
class Panda extends BasePay
{
    ...
    public function __construct()
    {
        ...
        $merchantId     = configure("finance_merchant_id");
        $key            = configure("finance_key");
        $gateway        = configure("finance_gateway");
     ...
     * @return array
     */
    public function getRechargeChannel($source = "phone") {
...
//        $params = Input::all();
    ...
    public function queryWithdrawOrderStatus($oWithdrawal, $channel = null){
        ...
        $this->updateWithdrawQueryLog(['content' => json_encode($returnData), "back_time" => time()]);
